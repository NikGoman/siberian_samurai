...
*   **Подтемы:**  
    - Карьерные трансформации из непрофильных сфер (стройка, армия, логистика → IT).  
    - Преодоление отказов, кризисов, миграции, финансовых потерь.  
    - Роль поддержки (жена, менторы) как условия для риска.  
    - Уроки от работы в ИКЕА, стройке, армии — как они формируют системное мышление.  
    - Подготовка к переходу в Product Manager.  
    - Синдром самозванца и страх «не знать всего».  
    - Этические дилеммы: «сохранить позицию» vs «остаться собой».  
    - Музыка как саундтрек к этапам жизни (**#музыкальная_среда**).  
    - Рефлексия через **#разбор_полетов**.  
*   **Целевая аудитория:** Люди 20–35 лет, сталкивающиеся с неуверенностью, страхом начала, синдромом самозванца, отсутствием поддержки при смене профессии. Боли: *«не верят в меня», «боюсь начать», «не знаю, как менять профессию»*.  
*   **Этап развития:** Запуск (0–1k подписчиков). Канал создан 02.09.2025. Текущее количество подписчиков: **72**.  
*   **Текущие метрики:** Средняя вовлечённость: 5–14 ❤️. Наибольший отклик — на темы уязвимости, этики, поддержки.  
...
*   **Обратная связь по постам:** Высокая вовлечённость на истории уязвимости, этического выбора, поддержки.  
*   **Дополнительный контекст:**  
    - AMA на Reddit: *«I’ve had 27 completely different jobs…»* (20K просмотров).  
    - Не раскрытые темы: роль армии/стройки/ИКЕА, цена многопрофильности, резюме как стратегия.  
...
*   **Ключевые принципы стиля:**  
    ...
    - Метафоричность («компас», «штекер», «тусовка»)  
...
*   **Стратегия монетизации (потенциальная):**  
    ...
    - **Ключевая ценность:** легитимация — «ты имеешь право быть здесь».  
### END CORE CONTEXT ###
...
### USER PROFILE ###
* Имя: Nikita Goman  
* Профессиональный путь: от стройки и армии → QA → Team Lead → переход в Product Manager  
* Опыт: управление командами до 45 человек, тестирование микросервисов, Linux, автоматизация  
* Личные интересы: автомобильная тематика, музыка, системное мышление  
* Ценности: этика, поддержка, честность, процесс важнее результата  
### END USER PROFILE ###
